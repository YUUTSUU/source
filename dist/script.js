...
/* harmony import */ var _modules_calcState__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/calcState */ "./src/js/modules/calcState.js");
...
/* harmony import */ var _modules_animated__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/animated */ "./src/js/modules/animated.js");
/* harmony import */ var _modules_scrolling__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/scrolling */ "./src/js/modules/scrolling.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var state = {};
  Object(_modules_animated__WEBPACK_IMPORTED_MODULE_12__["default"])();
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])("form", "input", state);
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])("textarea[name='message']");
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])(".button-styles");
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])("#size", "#material", "#options", ".promocode", ".calc-price");
  Object(_modules_calcState__WEBPACK_IMPORTED_MODULE_7__["default"])("#size", "change", "size", state);
  Object(_modules_calcState__WEBPACK_IMPORTED_MODULE_7__["default"])("#material", "change", "materialCoeff", state);
  Object(_modules_calcState__WEBPACK_IMPORTED_MODULE_7__["default"])("#options", "change", "options", state);
  Object(_modules_calcState__WEBPACK_IMPORTED_MODULE_7__["default"])(".promocode", "input", "promocode", state);
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_8__["default"])(".portfolio-menu", ".portfolio-wrapper", ".portfolio-no");
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_13__["default"])(".pageup");
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_14__["default"])("[name='upload']");
});
  ...
  trigger.forEach(function (item) {
    item.addEventListener('click', function () {
      if (this.classList.contains('active-style')) {
        ...
        this.nextElementSibling.style.maxHeight = this.nextElementSibling.scrollHeight + 80 + "px"; //плавный текст

        var i = this.nextElementSibling.className.split(" ")[2];
        document.querySelectorAll(".".concat(i, " p")).forEach(function (item) {
...
var animated = function animated() {
  var wowItem = document.querySelectorAll(".wow");
  wowItem.forEach(function (item) {
    if (item.classList.contains("wow")) {
      item.classList.replace("wow", "animated"); // item.setAttribute("data-wow-duration", "2s")
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");




var calc = function calc(sizeSelector, materialSelector, optionsSelector, promocodeSelector, resultSelector) {
  ...
  var errorMessage = document.querySelector(".calc-price");

  function result(selector) {
    Object(_services_service__WEBPACK_IMPORTED_MODULE_2__["getResource"])("http://localhost:3000/".concat(selector)).then(function (res) {
      return renderSelect(res, selector);
    }).catch(function () {
    ...
    switch (selector) {
      case "size":
        res.forEach(function (item) {
          ...
          option.setAttribute("value", "".concat(item.value));
          option.innerHTML = "".concat(item.title);
      ...
      case "material":
        res.forEach(function (item) {
          var option = document.createElement("option");
          option.setAttribute("value", "".concat(item.value));
          option.setAttribute("title", "".concat(item.descr));
          option.innerHTML = "".concat(item.title);
...
var calcState = function calcState(selector, event, prop, state) {
...
/* harmony default export */ __webpack_exports__["default"] = (calcState);
...
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/es.object.from-entries */ "./node_modules/core-js/modules/es.object.from-entries.js");
/* harmony import */ var core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_from_entries__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
var drop = function drop(inputSelector) {
  var fileInput = document.querySelectorAll(inputSelector);
  ...
  fileInput.forEach(function (item) {
    item.addEventListener("drop", function (event) {
      ...
      if (item.getAttribute("drop") === "image") {
        _toConsumableArray(files).forEach(function (item) {
          var formData = new FormData();
          formData.append("upload", item.name);
          var data = JSON.stringify(Object.fromEntries(formData.entries()));
          Object(_services_service__WEBPACK_IMPORTED_MODULE_13__["postData"])("http://localhost:3000/designer", data).then(function (res) {
            console.log(res);
          });
        });
      }
...
var filter = function filter(headerSelector, wrapperSelector, noSelector) {
  ...
  function showContentFilter(className) {
    var items = wrapper.querySelectorAll(".".concat(className));
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
var forms = function forms(formsSelector, inputSelector, state) {
  var formsItems = document.querySelectorAll(formsSelector),
  ...
  inputUpload.forEach(function (item) {
  ...
  formsItems.forEach(function (item) {
    item.addEventListener("submit", function (event) {
      event.preventDefault(); //сообщение >
      ...
      status.appendChild(statusMessage); //сообщение <
      ...
      item.closest(".popup-design") || item.classList.contains("form_calc") ? server = path.designer : server = path.question;
      var data = JSON.stringify(Object.fromEntries(formData.entries()));
      Object(_services_service__WEBPACK_IMPORTED_MODULE_9__["postData"])(server, data).then(function (res) {
        console.log(res);
...
var modals = function modals(triggerSelector, modalSelector, closeSelector) {
  var destroyGift = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  var offsetWidth = calcScroll();
  triggerModal.forEach(function (item) {
    item.addEventListener("click", function (event) {
      ...
      document.body.style.marginRight = "".concat(offsetWidth, "px");
      document.querySelector(".fixed-gift").style.marginRight = "".concat(offsetWidth, "px"); //gif offset

      document.querySelector(".pageup").style.marginRight = "".concat(offsetWidth, "px");
    });
  });
  ...
  function calcScroll() {
    ...
    var marginRight = div.offsetWidth - div.clientWidth;
    div.remove();
    return marginRight;
  }
};
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
var showMoreStyles = function showMoreStyles(trigger) {
  ...
  button.addEventListener("click", function () {
    Object(_services_service__WEBPACK_IMPORTED_MODULE_6__["getResource"])("http://localhost:3000/styles").then(function (res) {
...
var sliders = function sliders(sliderSelector, previousSelector, nextSelector, direction) {
  var slideIndex = 1,
      slidePaused = null;
  var sliderItems = document.querySelectorAll(sliderSelector); //отображение слайдера
  ...
  showSlides(slideIndex); //перелючение
  ...
  function activateAnimation() {
    ...
    if (direction === "vertical") {
      slidePaused = setInterval(function () {
        plusSlides(1);
  ...
  activateAnimation(); //остановка автослайдера
